...
func (ConfigSubPathMediaHttpPlugin) GetRequests() []l9format.WebPluginRequest {
...
func (ConfigSubPathMediaHttpPlugin) GetName() string {
        return "ConfigSubPathMediaHttpPlugin"
}

func (ConfigSubPathMediaHttpPlugin) GetStage() string {
        return "open"
}
