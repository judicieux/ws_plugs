...
func (ConfigSubPathApiHttpPlugin) GetRequests() []l9format.WebPluginRequest {
...
func (ConfigSubPathApiHttpPlugin) GetName() string {
        return "ConfigSubPathApiHttpPlugin"
}

func (ConfigSubPathApiHttpPlugin) GetStage() string {
        return "open"
}
