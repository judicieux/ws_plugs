...
func (EnvDevelopmentLocalHttpPlugin) GetRequests() []l9format.WebPluginRequest {
...
func (EnvDevelopmentLocalHttpPlugin) GetName() string {
        return "EnvDevelopmentLocalHttpPlugin"
}

func (EnvDevelopmentLocalHttpPlugin) GetStage() string {
        return "open"
}
...
func (plugin EnvDevelopmentLocalHttpPlugin) Verify(request l9format.WebPluginRequest, response l9format.WebPluginResponse, event *l9format.L9Event, options map[string]string) (hasLeak bool) {
        ...
        if match {
                ...
                event.Summary = "Found sensitive information in /.env.development.local:\n" + string(response.Body)
                return true
        }
