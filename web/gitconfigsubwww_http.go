...
func (ConfigSubPathWwwHttpPlugin) GetRequests() []l9format.WebPluginRequest {
...
func (ConfigSubPathWwwHttpPlugin) GetName() string {
        return "ConfigSubPathWwwHttpPlugin"
}

func (ConfigSubPathWwwHttpPlugin) GetStage() string {
        return "open"
}
