...
func (DockerComposeProdHttpPlugin) GetRequests() []l9format.WebPluginRequest {
...
func (DockerComposeProdHttpPlugin) GetName() string {
        return "DockerComposeProdHttpPlugin"
}

func (DockerComposeProdHttpPlugin) GetStage() string {
        return "open"
}
...
func (plugin DockerComposeProdHttpPlugin) Verify(request l9format.WebPluginRequest, response l9format.WebPluginResponse, event *l9format.L9Event, options map[string]string) (hasLeak bool) {
        ...
        if match {
                ...
                event.Summary = "Found sensitive information in /docker-compose.prod.yml:\n" + string(response.Body)
                return true
        }
