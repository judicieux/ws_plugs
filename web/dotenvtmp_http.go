...
type EnvTmpHttpPlugin struct {
        l9format.ServicePluginBase
}

func (EnvTmpHttpPlugin) GetVersion() (int, int, int) {
        return 0, 0, 2
}

func (EnvTmpHttpPlugin) GetRequests() []l9format.WebPluginRequest {
...
func (EnvTmpHttpPlugin) GetName() string {
        return "EnvTmpHttpPlugin"
}

func (EnvTmpHttpPlugin) GetStage() string {
        return "open"
}

func (plugin EnvTmpHttpPlugin) Verify(request l9format.WebPluginRequest, response l9format.WebPluginResponse, event *l9format.L9Event, options map[string]string) (hasLeak bool) {
        ...
        if match {
                ...
                event.Summary = "Found sensitive information in /.env.tmp:\n" + string(response.Body)
                return true
        }
