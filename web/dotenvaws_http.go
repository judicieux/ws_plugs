...
type EnvAwsHttpPlugin struct {
        l9format.ServicePluginBase
}

func (EnvAwsHttpPlugin) GetVersion() (int, int, int) {
        return 0, 0, 2
}

func (EnvAwsHttpPlugin) GetRequests() []l9format.WebPluginRequest {
...
func (EnvAwsHttpPlugin) GetName() string {
        return "EnvAwsHttpPlugin"
}

func (EnvAwsHttpPlugin) GetStage() string {
        return "open"
}

func (plugin EnvAwsHttpPlugin) Verify(request l9format.WebPluginRequest, response l9format.WebPluginResponse, event *l9format.L9Event, options map[string]string) (hasLeak bool) {
        ...
        if match {
                ...
                event.Summary = "Found sensitive information in /.env.aws:\n" + string(response.Body)
                return true
        }
